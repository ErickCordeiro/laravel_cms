            ...
            <form class="form-horizontal" action="{{ route('admin.pages.store') }}" method="post"
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input autofocus="true" type="text" value="{{ old('title') }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control contentfield" id="content" name="content" placeholder="Conteúdo"> {{ old('content') }}</textarea>
                        </div>
                    </div>
                </div>
